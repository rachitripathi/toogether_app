...
export const MOCK_EVENTS: Event[] = [
  ...
  },
  {
    ...
    description:
      'Trying momos, rolls, and one dessert stop. Keep it casual and bring an appetite.',
    dateTime: new Date(Date.now() + 30 * 60 * 60 * 1000).toISOString(),
    area: 'Fancy Bazar',
    timeSlot: 'Evening',
    exactTime: '6:45 PM',
    exactLocation: 'Entrance near Fancy Bazar market, Guwahati',
    location: 'Entrance near Fancy Bazar market, Guwahati',
    creatorId: 'u2',
    maxPeople: 6,
    approvedUserIds: [],
    requestUserIds: [],
  ...
  },
  {
    ...
    title: 'Console Night',
    description:
      'A few rounds of co-op games, snacks, and no serious scorekeeping.',
    dateTime: new Date(Date.now() + 52 * 60 * 60 * 1000).toISOString(),
    area: 'Silpukhuri',
    timeSlot: 'Night',
    exactTime: '8:00 PM',
    exactLocation: 'Game lounge near Silpukhuri, Guwahati',
    location: 'Game lounge near Silpukhuri, Guwahati',
    creatorId: 'u3',
    maxPeople: 5,
    approvedUserIds: [],
    requestUserIds: [],
  ...
  {
    id: 'e8',
    title: 'Open Plan Roulette',
    description:
      'No fixed agenda yet. We decide one simple plan together after everyone joins.',
    dateTime: new Date(Date.now() + 72 * 60 * 60 * 1000).toISOString(),
    area: 'Pan Bazar',
    timeSlot: 'Afternoon',
    exactTime: '3:30 PM',
    exactLocation: 'Cafe corner near Pan Bazar, Guwahati',
    location: 'Cafe corner near Pan Bazar, Guwahati',
    creatorId: 'u4',
    maxPeople: 7,
    approvedUserIds: [],
    requestUserIds: [],
