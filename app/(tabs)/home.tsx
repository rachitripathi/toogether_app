...
export default function HomeScreen() {
  ...
  const filtered = events.filter((event) => {
    ...
    const matchesVisibility = !event.womenOnly || currentUser?.gender === 'woman' || event.creatorId === currentUser?.id;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.page }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, gap: 18, paddingBottom: 110 }}>
        ...
        <View style={{ gap: 14 }}>
          {filtered.length ? (
            ...
            >
              ...
              <Text style={{ color: colors.text, fontSize: 18, fontWeight: '800' }}>No plans yet</Text>
