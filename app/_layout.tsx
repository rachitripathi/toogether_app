...
function VerificationPrompt() {
  ...
  return (
    <Modal
      transparent
      animationType="fade"
      visible={shouldShowVerificationPrompt}
      onRequestClose={dismissVerificationPrompt}
    >
      <View
        style={{
          flex: 1,
        ...
        >
          <View style={{ gap: 8 }}>
            ...
            <Text style={{ color: colors.muted, lineHeight: 22 }}>
              Verified profiles feel safer to join, usually get better reach,
              and make hosts more likely to approve requests quickly.
            </Text>
          </View>
          ...
          <GradientButton
            label="Got it"
            onPress={dismissVerificationPrompt}
            fullWidth
          />
          <Pressable
            onPress={dismissVerificationPrompt}
